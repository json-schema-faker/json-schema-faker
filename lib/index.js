(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('randexp'), require('tslib'), require('json-schema-ref-parser')) :
    typeof define === 'function' && define.amd ? define(['randexp', 'tslib', 'json-schema-ref-parser'], factory) :
    (global.JSONSchemaFaker = factory(global.RandExp,global.tslib_1,global.$RefParser));
}(this, (function (RandExp,tslib_1,$RefParser) {

RandExp = 'default' in RandExp ? RandExp['default'] : RandExp;
$RefParser = 'default' in $RefParser ? $RefParser['default'] : $RefParser;
...
var stringType = function stringType(value) {
    ...
    while (output.length < minLength) {
        output += Math.random() > 0.7 ? thunkGenerator() : randexp$1('.+');
    }
