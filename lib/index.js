...
// TODO: implements
// this function should resolve `(schema, refs)` for local
// json-references only, e.g. #/definitions/foo/bar
var deref = function (schema) {
    return schema;
};
...
jsf.sync = function (schema, refs) { return run(deref(schema, refs), container); };
jsf.utils = utils;
