...
var regexps = require('../core/regexp');
var formats = require('../api/formats');
var container = require('../class/Container');
var faker = container.get('faker'), chance = container.get('chance'), randexp = container.get('randexp').randexp;
...
function stringType(value) {
    ...
    var min = Math.max(0, value.minLength || 0), max = random.number(min, value.maxLength || 140);
    var sample = thunk();
